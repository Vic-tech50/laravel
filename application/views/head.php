...
<link href="<?= base_url();?>https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500&amp;display=swap" rel="stylesheet">
...
<a href="<?= base_url();?>index-2.html"><img src="<?= base_url();?>img/logo.png" alt="#"></a>
</div>
</div>
...
<li class="menu-item-has-children active"><a href="<?= base_url();?>#">Home</a>
<ul class="sub-menu">
<li><a href="<?= base_url();?>index-2.html">Homepage 01</a></li>
<li><a href="<?= base_url();?>index-3.html">Homepage 02</a></li>
<li><a href="<?= base_url();?>index-4.html">Homepage 03</a></li>
</ul>
</li>
<li class="menu-item-has-children"><a href="<?= base_url();?>#">Properties</a>
<ul class="sub-menu">
<li><a href="<?= base_url();?>property-grid.html">Properties</a></li>
<li><a href="<?= base_url();?>property-single.html">Property Single</a></li>
<li><a href="<?= base_url();?>add-property.html">Add Property</a></li>
<li><a href="<?= base_url();?>dashboard.html">Dashboard</a></li>
<li><a href="<?= base_url();?>submit-property.html">Submit Property</a></li>
<li><a href="<?= base_url();?>edit-property.html">Edit Property</a></li>
</ul>
</li>
...
<li><a href="<?= base_url();?>payment-method.html">Payment Method</a></li>
<li><a href="<?= base_url();?>faq.html">Faq's</a></li>
<li><a href="<?= base_url();?>login.html">Login</a></li>
<li><a href="<?= base_url();?>signup.html">Signup</a></li>
<li><a href="<?= base_url();?>404.html">Error Page</a></li>
</ul>
</li>
<li class="menu-item-has-children"><a href="<?= base_url();?>#">Agents</a>
<ul class="sub-menu">
<li><a href="<?= base_url();?>our-agent.html">Our Agent</a></li>
<li><a href="<?= base_url();?>agent-detail.html">Agent Details</a></li>
</ul>
</li>
<li class="menu-item-has-children"><a href="<?= base_url();?>#">News</a>
<ul class="sub-menu">
<li><a href="<?= base_url();?>blog.html">News</a></li>
<li><a href="<?= base_url();?>blog-single.html">News Single</a></li>
</ul>
</li>
...
<!-- <li>
<a href="<?= base_url();?>https://quomodothemes.website/cdn-cgi/l/email-protection#377f585a5274040377505a565e5b1954585a">
<img src="<?= base_url();?>img/email-icon.svg" alt="#">
<span><span class="__cf_email__" data-cfemail="f1b99e9c94b2c2c5b1969c90989ddf929e9c">[email&#160;protected]</span></span>
</a>
</li> -->
<li>
<a href="<?= base_url();?>tel:+00239040248">
<img src="<?= base_url();?>img/phone-icon.svg" alt="#">
<span>+00 23904 0248</span>
</a>
</li>
<li>
<a href="<?= base_url();?>https://quomodothemes.website/cdn-cgi/l/email-protection#bcf4d3d1d9ff8f88fcdbd1ddd5d092dfd3d1">
<img src="<?= base_url();?>img/locations-icon.svg" alt="#">
...
<?php if($this->uri->segment(1) == 'user'){
           echo '<a href="'.site_url("dash"). '"  class="homec-header__icon">
...
echo '<a href="'.site_url("logout"). '"  class="homec-btn btn-danger"><span>Logout</span></a>';
  }elseif($this->uri->segment(1) == 'agent'){

           echo '<a href="'.site_url("agent/dashboard"). '"  class="homec-header__icon">
<svg width="28" height="32" viewBox="0 0 28 32" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13.9659 16.2014C18.423 16.2014 22.0666 12.5579 22.0666 8.1007C22.0666 3.64352 18.423 0 13.9659 0C9.50869 0 5.86523 3.64352 5.86523 8.1007C5.86523 12.5579 9.50876 16.2014 13.9659 16.2014Z" />
<path d="M27.8681 22.6752C27.6558 22.1446 27.3729 21.6494 27.0545 21.1895C25.4273 18.784 22.9158 17.1922 20.0858 16.8031C19.7321 16.7677 19.343 16.8384 19.06 17.0507C17.5743 18.1473 15.8056 18.7133 13.9661 18.7133C12.1266 18.7133 10.3579 18.1473 8.87219 17.0507C8.58917 16.8384 8.20005 16.7323 7.84634 16.8031C5.0164 17.1922 2.46948 18.784 0.877655 21.1895C0.55929 21.6494 0.276269 22.18 0.0640708 22.6752C-0.0420283 22.8875 -0.00668454 23.1351 0.0994145 23.3474C0.382436 23.8426 0.736144 24.3379 1.05451 24.7623C1.54973 25.4345 2.08036 26.0358 2.68174 26.6018C3.17696 27.097 3.74294 27.5569 4.30898 28.0167C7.10351 30.1039 10.4641 31.2004 13.9307 31.2004C17.3974 31.2004 20.758 30.1038 23.5525 28.0167C24.1185 27.5923 24.6845 27.097 25.1798 26.6018C25.7457 26.0358 26.3117 25.4344 26.807 24.7623C27.1607 24.3025 27.4791 23.8426 27.7621 23.3474C27.9389 23.1351 27.9742 22.8874 27.8681 22.6752Z" />
</svg>
</a>';
echo '<a href="'.site_url("agent/add_property"). '"  class="homec-btn"><span>Add Property</span></a>';
  }else{
  	echo '<a href="'.site_url("login"). '"  class="homec-header__icon">
<svg width="28" height="32" viewBox="0 0 28 32" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13.9659 16.2014C18.423 16.2014 22.0666 12.5579 22.0666 8.1007C22.0666 3.64352 18.423 0 13.9659 0C9.50869 0 5.86523 3.64352 5.86523 8.1007C5.86523 12.5579 9.50876 16.2014 13.9659 16.2014Z" />
<path d="M27.8681 22.6752C27.6558 22.1446 27.3729 21.6494 27.0545 21.1895C25.4273 18.784 22.9158 17.1922 20.0858 16.8031C19.7321 16.7677 19.343 16.8384 19.06 17.0507C17.5743 18.1473 15.8056 18.7133 13.9661 18.7133C12.1266 18.7133 10.3579 18.1473 8.87219 17.0507C8.58917 16.8384 8.20005 16.7323 7.84634 16.8031C5.0164 17.1922 2.46948 18.784 0.877655 21.1895C0.55929 21.6494 0.276269 22.18 0.0640708 22.6752C-0.0420283 22.8875 -0.00668454 23.1351 0.0994145 23.3474C0.382436 23.8426 0.736144 24.3379 1.05451 24.7623C1.54973 25.4345 2.08036 26.0358 2.68174 26.6018C3.17696 27.097 3.74294 27.5569 4.30898 28.0167C7.10351 30.1039 10.4641 31.2004 13.9307 31.2004C17.3974 31.2004 20.758 30.1038 23.5525 28.0167C24.1185 27.5923 24.6845 27.097 25.1798 26.6018C25.7457 26.0358 26.3117 25.4344 26.807 24.7623C27.1607 24.3025 27.4791 23.8426 27.7621 23.3474C27.9389 23.1351 27.9742 22.8874 27.8681 22.6752Z" />
</svg>
</a>';
echo '<a href="'.site_url("signup"). '"  class="homec-btn"><span>Become An Agent</span></a>';
  }
?>


<!-- <a href="<?= site_url('login');?>" class="homec-btn"><span>Add Property</span></a> -->
</div>
</div>
</div>
</div>
