...
<section id="hero" class="homec-hero homec-hero__v2 p-relative" style="background-image:url('<?= base_url(); ?>img/map.svg');">
<div class="container">
...
<h1 class="homec-hero__title">Get your <span class="homec-hero__title--focus" style="background-image:url('<?= base_url(); ?>img/shape-2.svg')">Property</span> With Agents.</h1>
...
<img src="<?= base_url();?>img/property-featured.jpg" alt="#">
</div>
...
<img src="<?= base_url();?>img/location-icon2.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
</div>

<ul class="homec-property__list homec-border-top list-none">
<li><img src="<?= base_url();?>img/room-icon2.svg" alt="#">3 Room</li>
<li><img src="<?= base_url();?>img/bath-icon2.svg" alt="#">2 Bathroom</li>
<li><img src="<?= base_url();?>img/size-icon2.svg" alt="#">5x9 m2</li>
</ul>
</div>
</div>
</a>
...
<div class="homec-property__head">
<div class="homec-overlay"></div>
<img src="<?= base_url();?>img/property-featured2.jpg" alt="#">
</div>
...
<form class="homec-search-form__form homec-search-form__form--city" action="https://quomodothemes.website/html/homeco/property-grid.html">
...
<img src="<?= base_url();?>uploads/<?= $value['image']; ?>" alt="<?= $value['image']; ?>" style = "width: 276px; height: 316px;" >
<div class="homec-overlay homec-listing__overlay"></div>
<h4 class="homec-listing__title"><span>4+ Listing</span><?php echo $value['type']; ?></h4>
</a>
</div>
</div>
...
<div class="homec-listing__inner">
<a href="property-grid.html">
<img src="<?= base_url();?>img/listing-img3.jpg" alt="#">
<div class="homec-overlay homec-listing__overlay"></div>
...
<div class="homec-listing__inner">
<a href="property-grid.html">
<img src="<?= base_url();?>img/listing-img4.jpg" alt="#">
<div class="homec-overlay homec-listing__overlay"></div>
...
<div class="homec-listing__inner">
<a href="property-grid.html">
<img src="<?= base_url();?>img/listing-img5.jpg" alt="#">
<div class="homec-overlay homec-listing__overlay"></div>
...
<div class="homec-listing__inner">
<a href="property-grid.html">
<img src="<?= base_url();?>img/listing-img6.jpg" alt="#">
<div class="homec-overlay homec-listing__overlay"></div>
...
<div class="homec-listing__inner">
<a href="property-grid.html">
<img src="<?= base_url();?>img/listing-img7.jpg" alt="#">
<div class="homec-overlay homec-listing__overlay"></div>
...
<div class="homec-listing__inner">
<a href="property-grid.html">
<img src="<?= base_url();?>img/listing-img8.jpg" alt="#">
<div class="homec-overlay homec-listing__overlay"></div>
...
<a href="property-grid.html" class="homec-btn"><span>See More</span></a>
</div>
</div>
</div>
</section>
...
<div class="homec-shape-single homec-shape-1"><img src="<?= base_url();?>img/anim-shape-1.svg" alt="#"></div>
<div class="homec-shape-single homec-shape-2"><img src="<?= base_url();?>img/anim-shape-2.svg" alt="#"></div>
<div class="homec-shape-single homec-shape-3"><img src="<?= base_url();?>img/anim-shape-3.svg" alt="#"></div>
<div class="homec-shape-single homec-shape-4"><img src="<?= base_url();?>img/anim-shape-1.svg" alt="#"></div>
<div class="homec-shape-single homec-shape-5"><img src="<?= base_url();?>img/anim-shape-2.svg" alt="#"></div>
<div class="homec-shape-single homec-shape-6"><img src="<?= base_url();?>img/anim-shape-3.svg" alt="#"></div>
</div>
<div class="container">
<div class="row align-items-center">
...
<img src="<?= base_url();?>img/about-3.jpg" alt="#">
...
<div class="homec-overlay"></div>
<img src="<?= base_url();?>img/ceo-img.png" alt="#">
</div>
...
<span class="homec-section__badge homec-section__badge--shape" style="background-image:url('img/section-shape.svg')">About Homeco</span>
</div>
<h2 class="homec-section__title">Have done some Coo Stuff with common users</h2>
</div>
...
<img src="<?= base_url();?>img/count-icon1.svg" alt="#">
</div>
...
<div class="homec-funfact__single homec-funfact__single--v2">
<div class="homec-funfact__icon">
<img src="<?= base_url();?>img/count-icon2.svg" alt="#">
</div>
...
<section class="homec-properties homec-bg-cover  pd-top-120 pd-btm-120" style="background-image: url('<?= base_url();?>img/bg-shape-four.svg');">
<div class="homec-shape">
<div class="homec-shape-single homec-shape-7"><img src="<?= base_url();?>img/anim-shape-4.svg" alt="#"></div>
<div class="homec-shape-single homec-shape-8"><img src="<?= base_url();?>img/anim-shape-5.svg" alt="#"></div>
</div>
<div class="container">
<div class="row">
<div class="col-12">
...
<div class="homec-property__head">
<img src="<?= base_url();?>uploads/<?= $prop['image']?>" alt="#">
...
<img src="<?= base_url();?>img/agent-1.jpg" alt="#">
<h4 class="homec-property__asticky--label"><?= $prop['fullname']?><span>Agent</span></h4>
</a>
</div>
...
<div class="homec-property__price"><?= $prop['price']?> <span></span></div>
<span class="homec-property__salebadge">To Sale</span>
</div>
<h3 class="homec-property__title"><a href="property-single.html"><?= $prop['title']?></a></h3>
<div class="homec-property__text">
<img src="<?= base_url();?>img/location-icon.svg" alt="#"><p><?= $prop['city']?>, <?= $prop['address']?> <?= $prop['address_detail']?></p>
</div>

<ul class="homec-property__list homec-border-top list-none">
<li><img src="<?= base_url();?>img/room-icon.svg" alt="#"><?= $prop['bedroom']?> Room</li>
<li><img src="<?= base_url();?>img/bath-icon.svg" alt="#"><?= $prop['bathroom']?> Bathroom</li>
<li><img src="<?= base_url();?>img/size-icon.svg" alt="#"><?= $prop['area']?></li>
</ul>
</div>
</div>
...
<div class="homec-property__head">
<img src="<?= base_url();?>img/property-img12.png" alt="#">
...
<a href="agent-detail.html" class="homec-property__asticky">
<img src="<?= base_url();?>img/agent-2.jpg" alt="#">
...
<div class="homec-property__text">
<img src="<?= base_url();?>img/location-icon.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
</div>

<ul class="homec-property__list homec-border-top list-none">
<li><img src="<?= base_url();?>img/room-icon.svg" alt="#">3 Room</li>
<li><img src="<?= base_url();?>img/bath-icon.svg" alt="#">2 Bathroom</li>
<li><img src="<?= base_url();?>img/size-icon.svg" alt="#">5x9 m2</li>
</ul>
</div>
</div>
...
<div class="homec-property__head">
<img src="<?= base_url();?>img/property-img13.png" alt="#">
...
<a href="agent-detail.html" class="homec-property__asticky">
<img src="<?= base_url();?>img/agent-3.jpg" alt="#">
<h4 class="homec-property__asticky--label">Wade Wirren<span>Agent</span></h4>
</a>
</div>
...
<div class="homec-property__head">
<img src="<?= base_url();?>img/property-img14.png" alt="#">
...
<a href="agent-detail.html" class="homec-property__asticky">
<img src="<?= base_url();?>img/agent-4.jpg" alt="#">
<h4 class="homec-property__asticky--label">Wade Wirren<span>Agent</span></h4>
</a>
</div>
...
<div class="homec-property__head">
<img src="<?= base_url();?>img/property-img15.png" alt="#">
...
<a href="agent-detail.html" class="homec-property__asticky">
<img src="<?= base_url();?>img/agent-5.jpg" alt="#">
<h4 class="homec-property__asticky--label">Wade Wirren<span>Agent</span></h4>
</a>
</div>
...
<div class="homec-property__head">
<img src="<?= base_url();?>img/property-img16.png" alt="#">
...
<a href="agent-detail.html" class="homec-property__asticky">
<img src="<?= base_url();?>img/agent-6.jpg" alt="#">
<h4 class="homec-property__asticky--label">Wade Wirren<span>Agent</span></h4>
</a>
</div>
...
<a href="property-grid.html" class="homec-btn"><span>See all Properties</span></a>
</div>
</div>
</div>
</section>
...
<div class="homec-features-list__first">
<div class="homec-features-list__icon">
<img src="<?= base_url();?>img/support-icon.svg" alt="#">
</div>
...
<div class="homec-features-list__first">
<div class="homec-features-list__icon">
<img src="<?= base_url();?>img/finance-icon.svg" alt="#">
</div>
...
<div class="homec-features-list__first">
<div class="homec-features-list__icon">
<img src="<?= base_url();?>img/wide-house-icon.svg" alt="#">
</div>
...
<img src="<?= base_url();?>img/agent-9.jpg" alt="#">
</div>
...
<h4 class="homec-agent__title"><a href="agent-detail.html">Floyd Miles<span>Real Estate Broker</span></a></h4>
</div>
...
<div class="homec-agent__head">
<img src="<?= base_url();?>img/agent-10.jpg" alt="#">
</div>
...
<h4 class="homec-agent__title"><a href="agent-detail.html">Robert Fox<span>Real Estate Broker</span></a></h4>
</div>
...
<div class="homec-agent__head">
<img src="<?= base_url();?>img/agent-11.jpg" alt="#">
</div>
...
<h4 class="homec-agent__title"><a href="agent-detail.html">Dianne Russell<span>Real Estate Broker</span></a></h4>
</div>
...
<div class="homec-agent__head">
<img src="<?= base_url();?>img/agent-12.jpg" alt="#">
</div>
...
<h4 class="homec-agent__title"><a href="agent-detail.html">Esther Howard<span>Real Estate Broker</span></a></h4>
</div>
...
<div class="homec-agent__head">
<img src="<?= base_url();?>img/agent-13.jpg" alt="#">
</div>
...
<h4 class="homec-agent__title"><a href="agent-detail.html">Devon Lane<span>Real Estate Broker</span></a></h4>
</div>
...
<h4 class="homec-agent__title"><a href="agent-detail.html">Wade Warren<span>Real Estate Broker</span></a></h4>
</div>
...
<img src="<?= base_url();?>img/support-img.png" alt="#">
<div class="homec-support-img__content">
<img src="<?= base_url();?>img/support-icon-white.svg" alt="#">
...
<div class="homec-shape">
<div class="homec-shape-single homec-shape-11"><img src="<?= base_url();?>img/anim-shape-10.svg" alt="#"></div>
<div class="homec-shape-single homec-shape-12"><img src="<?= base_url();?>img/anim-shape-10.svg" alt="#"></div>
<div class="homec-shape-single homec-shape-13"><img src="<?= base_url();?>img/anim-shape-10.svg" alt="#"></div>
</div>
<div class="container">
<div class="row">
<div class="col-12">
...
<img src="<?= base_url();?>img/app-screen.png" alt="#">
</div>
</div>
</div>
</div>
...
<a href="blog-single.html"><img src="<?= base_url();?>img/blog-1.jpg" alt="#"></a>
...
<div class="homec-blog__head">
<div class="homec-overlay homec-blog__overlay"></div>
<a href="blog-single.html"><img src="<?= base_url();?>img/blog-2.jpg" alt="#"></a>
...
<div class="homec-blog__head">
<div class="homec-overlay homec-blog__overlay"></div>
<a href="blog-single.html"><img src="<?= base_url();?>img/blog-3.jpg" alt="#"></a>
