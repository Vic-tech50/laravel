...
<!-- Mirrored from quomodothemes.website/html/homeco/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Aug 2023 17:20:50 GMT -->
<head>
...
<section class="ecom-wc ecom-wc__full ecom-bg-cover" style="background-image: url('img/credential-bg.html');">
<div class="container-fluid">
<div class="row">
<div class="col-lg-6 col-12">
<div class="ecom-wc__form">
<div class="ecom-wc__form-inner">
<h3 class="ecom-wc__form-title ecom-wc__form-title__one">Login <span>Your email address will not be published. Required fields are marked *</span></h3>

<form class="ecom-wc__form-main p-0" action="<?= site_url('login/auth')?>" method="post">
<div class="form-group homec-form-input">
<label class="ecom-wc__form-label mg-btm-10">Email*</label>
<div class="form-group__input">
<input class="ecom-wc__form-input" type="email" name="email"  required="required">
</div>
</div>
...
<p class="ecom-wc__text">Dont’t have an account ? <a href="<?= site_url('signup');?>">Create Account</a></p>
</div>
</div>
</form>
...
<a href="<?= base_url();?>#" class="scrollToTop">Up Now<i class="fa-solid fa-angle-right"></i></a>
...
<!-- Mirrored from quomodothemes.website/html/homeco/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Aug 2023 17:20:53 GMT -->
</html>